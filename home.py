...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, HR_Page):
        ...
        self.List_employee_text.setText(QCoreApplication.translate("HR_Page", u"List of Employess", None))
        ...
        self.Remove_text.setText(QCoreApplication.translate("HR_Page", u"Remove Employee", None))
        ...
        self.Department_Text_2.setText(QCoreApplication.translate("HR_Page", u"Department:", None))
        self.View_Edit.setTitle("")
        self.View_edit_text.setText(QCoreApplication.translate("HR_Page", u"View and Edit Employee", None))
        self.Password_text_2.setText(QCoreApplication.translate("HR_Page", u"Password:", None))
        self.Contact_text_2.setText(QCoreApplication.translate("HR_Page", u"Contact #:", None))
        self.Employee_id_text_2.setText(QCoreApplication.translate("HR_Page", u"Employee ID:", None))
        self.Email_text_2.setText(QCoreApplication.translate("HR_Page", u"Email:", None))
        self.Save_button.setText(QCoreApplication.translate("HR_Page", u"Save", None))
        self.Lname_text_2.setText(QCoreApplication.translate("HR_Page", u"Last Name:", None))
        self.Fname_text_2.setText(QCoreApplication.translate("HR_Page", u"First Name:", None))
        self.Salary_text_2.setText(QCoreApplication.translate("HR_Page", u"Salary:", None))
        self.Address_text_2.setText(QCoreApplication.translate("HR_Page", u"Address:", None))
        self.back_button.setText(QCoreApplication.translate("HR_Page", u"Back", None))
    # retranslateUi
