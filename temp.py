...
"")
    ...
    def setup_connections(self, stacked_widget):
        ...
        self.Add_employee.clicked.connect(lambda: stacked_widget.setCurrentIndex(1))
...
class Add_Employee_page(QWidget):
    def __init__(self,Page):
        ...
        self.title_bar_2 = QGroupBox(self)
        ...
        self.new_employee_text = QLabel(self.title_bar_3)
        self.new_employee_text.setObjectName(u"new_employee_text_2")
...
"")
    ...
    def add_employee_to_database(self):
        ...
        if not is_valid_email(email):
            ...
            self.show_error_message(error_message)
            return
        if not self.Contact.text().isdigit():
        ...
        try:
            ...
            cursor.execute("""
                INSERT INTO Employee (id, department, Fname, Lname, contact, address, email, password)
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
            """, (employee_id, department, fname, lname, contact, address, email, password))
...
class LeavePage(QWidget):
    def __init__(self):
        super(LeavePage, self).__init__()

        self.setObjectName(u"Leave")
        self.setGeometry(0, 0, 291, 256)

        self.Pending = QPushButton(self)
        # ... (Rest of the initialization code for Pending button)

        self.Approve = QPushButton(self)
        # ... (Rest of the initialization code for Approve button)

        self.Decline = QPushButton(self)
        # ... (Rest of the initialization code for Decline button)
...
class HRPage(QMainWindow):
    def __init__(self):
        super(HRPage, self).__init__()

        self.setObjectName(u"HR_Page")
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(QCoreApplication.translate("HR_Page", u"MainWindow", None))
        self.side_bar.setTitle(QCoreApplication.translate("HR_Page", u"GroupBox", None))
        self.side_bar.Dashboard_button.setText(QCoreApplication.translate("HR_Page", u"Dashboard", None))
        self.side_bar.attendance.setText(QCoreApplication.translate("HR_Page", u"Attendance", None))
        self.side_bar.list_employee.setText(QCoreApplication.translate("HR_Page", u"List of Employee", None))
        self.side_bar.Add_employee.setText(QCoreApplication.translate("HR_Page", u"Add Employee", None))
        self.side_bar.Remove_employee.setText(QCoreApplication.translate("HR_Page", u"Remove Employee", None))
        self.side_bar.EandL.setItemText(self.side_bar.EandL.indexOf(self.side_bar.Employee), QCoreApplication.translate("HR_Page", u"Employee", None))
        self.side_bar.Pending.setText(QCoreApplication.translate("HR_Page", u"Pending", None))
        self.side_bar.Approve.setText(QCoreApplication.translate("HR_Page", u"Approved", None))
        self.side_bar.Decline.setText(QCoreApplication.translate("HR_Page", u"Declined", None))
        self.side_bar.EandL.setItemText(self.side_bar.EandL.indexOf(self.side_bar.Leave), QCoreApplication.translate("HR_Page", u"Leave", None))
        self.side_bar.Logo.setText("")
        self.dashboard_page.title_bar.setTitle("")
        self.dashboard_page.Dashboard_text.setText(QCoreApplication.translate("HR_Page", u"Dashboard", None))
        self.dashboard_page.home_text.setText(QCoreApplication.translate("HR_Page", u"Home  /", None))
        self.dashboard_page.HR_dashboard_text.setText(QCoreApplication.translate("HR_Page", u"HR's  Dashboard", None))
        self.dashboard_page.active_employee.setTitle("")
        self.dashboard_page.active_employee_text.setText(QCoreApplication.translate("HR_Page", u"Active Employees", None))
        self.dashboard_page.active_employee_count.setText(QCoreApplication.translate("HR_Page", u"10", None))
        self.dashboard_page.active_employee_logo.setText("")
        self.dashboard_page.pending_leaves.setTitle("")
        self.dashboard_page.pending_leaves_text.setText(QCoreApplication.translate("HR_Page", u"Pending Leaves", None))
        self.dashboard_page.pending_leaves_logo.setText("")
        self.dashboard_page.pending_leaves_count.setText(QCoreApplication.translate("HR_Page", u"4", None))
        self.dashboard_page.approved_leaves.setTitle("")
        self.dashboard_page.approved_leaves_logo.setText("")
        self.dashboard_page.approved_leaves_text.setText(QCoreApplication.translate("HR_Page", u"Approved Leaves", None))
        self.dashboard_page.approved_leaves_count.setText(QCoreApplication.translate("HR_Page", u"5", None))
        self.dashboard_page.declined_leaves.setTitle("")
        self.dashboard_page.declined_leaves_logo.setText("")
        self.dashboard_page.declined_leaves_text.setText(QCoreApplication.translate("HR_Page", u"Declined Leaves", None))
        self.dashboard_page.declined_leaves_count.setText(QCoreApplication.translate("HR_Page", u"11", None))
        
        self.addEmployee_page.title_bar_2.setTitle("")
        self.addEmployee_page.new_employee_text.setText(QCoreApplication.translate("HR_Page", u"Add New Employee", None))
        self.addEmployee_page.Department.setItemText(0, QCoreApplication.translate("HR_Page", u"    Marketing", None))
        self.addEmployee_page.Department.setItemText(1, QCoreApplication.translate("HR_Page", u"    Accounts", None))
        self.addEmployee_page.Department.setItemText(2, QCoreApplication.translate("HR_Page", u"    Sales", None))
        self.addEmployee_page.Department.setItemText(3, QCoreApplication.translate("HR_Page", u"    Finance", None))
        self.addEmployee_page.Department.setItemText(4, QCoreApplication.translate("HR_Page", u"    Research", None))

        self.addEmployee_page.Department_Text.setText(QCoreApplication.translate("HR_Page", u"Department:", None))
        self.addEmployee_page.Employee_id_text.setText(QCoreApplication.translate("HR_Page", u"Employee ID:", None))
        self.addEmployee_page.Fname_text.setText(QCoreApplication.translate("HR_Page", u"First Name:", None))
        self.addEmployee_page.Lname_text.setText(QCoreApplication.translate("HR_Page", u"Last Name:", None))
        self.addEmployee_page.Contact_text.setText(QCoreApplication.translate("HR_Page", u"Contact #:", None))
        self.addEmployee_page.Address_text.setText(QCoreApplication.translate("HR_Page", u"Address:", None))
        self.addEmployee_page.Email_text.setText(QCoreApplication.translate("HR_Page", u"Email:", None))
        self.addEmployee_page.Password_text.setText(QCoreApplication.translate("HR_Page", u"Password:", None))
        self.addEmployee_page.pushButton.setText(QCoreApplication.translate("HR_Page", u"ADD", None))
        self.addEmployee_page.Salary_text.setText(QCoreApplication.translate("HR_Page", u"Salary:", None))
